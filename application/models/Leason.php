...
class Leason extends CI_Model
{

	var $table = 'leasons'; //nama tabel dari database
	var $column_order = array('id', 'package_id', 'name');
	var $column_search = array('id', 'package_id', 'name');
